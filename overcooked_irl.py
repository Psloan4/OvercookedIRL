...
class OvercookedIRL:
    ...
    def __init__(self):
        ...
        # Stations
        self.stations = [
            Station(75, 120, 158, 260, self.feed_relay, 2, "1", self.item_handler, True),
            Station(75 + 158, 120, 203, 135, self.feed_relay, 2, "2a", self.item_handler, True),
            Station(75 + 158, 120 + 135, 203, 125, self.feed_relay, 2, "2b", self.item_handler, True),
            Station(75 + 158 + 203, 120, 121, 260, self.feed_relay, 2, "3", self.item_handler, True),
        ]
